...
final_chain = RunnablePassthrough.assign(
    coverage_data_raw=coverage_evaluator_chain
) | coverage_model_chain
...
existingLifeInsurance = st.number_input("Existing Life Insurance")
existingHealthInsurance = st.number_input("Existing Health Insurance")
existingAssetInsurance = st.number_input("Existing Asset Insurance")
...
if name and age and location and occupation and annualIncome and dependents and existingLifeInsurance and existingHealthInsurance and existingAssetInsurance:
    ...
    coverage_evaluator_response = final_chain.invoke({
        "name": name,
        "age": age,
        "location": location,
        "occupation": occupation,
